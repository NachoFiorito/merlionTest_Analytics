  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testsApp.sales.home.createOrEditLabel">
            <Translate contentKey="testsApp.sales.home.createOrEditLabel">Create or edit a Sales</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="stateLabel" for="sales-state">
                  <Translate contentKey="testsApp.sales.state">State</Translate>
                </Label>
                <AvInput
                  id="sales-state"
                  type="select"
                ...
                >
                  <option value="IN_CHARGE">{translate('testsApp.State.IN_CHARGE')}</option>
                  <option value="SHIPPED">{translate('testsApp.State.SHIPPED')}</option>
                  <option value="DELIVERED">{translate('testsApp.State.DELIVERED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="dateLabel" for="sales-date">
                  <Translate contentKey="testsApp.sales.date">Date</Translate>
                </Label>
                <AvField id="sales-date" type="date" className="form-control" name="date" />
              </AvGroup>
              <AvGroup>
                <Label for="sales-product">
                  <Translate contentKey="testsApp.sales.product">Product</Translate>
                </Label>
