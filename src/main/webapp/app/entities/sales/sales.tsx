...
export const Sales = (props: ISalesProps) => {
  ...
  return (
    <div>
      <h2 id="sales-heading">
        <Translate contentKey="testsApp.sales.home.title">Sales</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="testsApp.sales.home.createLabel">Create new Sales</Translate>
        </Link>
      </h2>
        ...
        {salesList && salesList.length > 0 ? (
            ...
            <tbody>
              {salesList.map((sales, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`testsApp.State.${sales.state}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="testsApp.sales.home.notFound">No Sales found</Translate>
            </div>
          )
        )}
      </div>
